...
class msInformUserMailingGroupUpdateProcessor extends modObjectUpdateProcessor
{
    public $objectType = 'msInformUserMailingGroup';
...
return 'msInformUserMailingGroupUpdateProcessor';
